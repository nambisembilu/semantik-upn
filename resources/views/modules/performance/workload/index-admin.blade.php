        ...
        <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            {!! getSvgIcon('media/icons/duotune/general/gen021.svg', 'svg-icon svg-icon-1 position-absolute ms-6') !!}
                            <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                            <input type="text"  data-kt-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Pencarian"/>
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
            ...
            <div class="card-body px-10">
                <div class="table-responsive">
                    <!--begin::Table-->
                    <table id="datatable" class="table align-middle fs-6 gs-2 gy-4">
                        <!--begin::Table head-->
                        <thead>
                        <!--begin::Table row-->
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex flex-column">
                                                @if($personal_workload->is_completed==1)
                                                    <a href="{{route('modules.performance.workload.edit-admin',[$personal_workload->id])}}"  target="_blank" class="text-primary text-hover-warning mb-1">{{$personal_workload->personal->name}}</a>
