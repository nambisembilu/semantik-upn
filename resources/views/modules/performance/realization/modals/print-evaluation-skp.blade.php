...
<div class="modal fade" id="modalPrintEvaluationSKP" tabindex="-1"
    aria-labelledby="modalPrintSKPLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form target="_blank" id="modal-print-form" action="{{route('modules.performance.realization.print_evaluation_skp')}}" method="get">
                @csrf
            ...
            <div class="tab-pane active" id="setting" role="tabpanel" aria-labelledby="setting-tab">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="date_setting" name="date_setting" required="" value="{{$dateSetting}}">
                    </div>
                </div>
                <div class="form-group row">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary px-3" onclick="ClosePrintEvaluationSKPModal()">Batal</button>
