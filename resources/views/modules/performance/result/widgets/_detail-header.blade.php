            ...
            <div class="card-header px-7">
                ...
                <div class="card-toolbar d-flex align-items-end flex-column">
                    ...
                    <span class="card-label text-gray-800 fs-3 fw-bolder me-3">
                        SKP Tahun {{ $work_performance_result->year }}
                    </span>
                    ...
                    @if ($work_performance_result->status == '1')
                        <span class="fs-8 badge badge-success">Selesai</span>
                    @else
                        <span class="fs-8 badge badge-secondary">Sedang Berlangsung</span>
                    @endif
                </div>
            </div>
    ...
    <div class="col-12">
        <div class="card mb-5 mb-xxl-8">
            <div class="card-body pt-9 pb-0">
                <!--begin::Details-->
                <div class="p-1">
                    <a href="#" class="btn btn-primary  mb-2"><span class="bi bi-printer-fill"></span>
                        Cetak
                    </a>
                </div>
            </div>
