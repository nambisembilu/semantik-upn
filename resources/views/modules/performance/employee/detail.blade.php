                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-title flex-column">
                            <h3 class="fw-bolder mb-1">Kinerja Utama</h3>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-top gs-2 gy-4">
                                ...
                                <tr class="fw-bolder text-light bg-primary">
                                    <th class="ps-4 min-w-250px rounded-start">Kinerja</th>
                                    <th class="min-w-100px">Beban Kerja</th>
                                ...
                                @foreach($personal_workload_activities as $personal_workload_activity)
                                    @php
                                        ...
                                        $personal_workload_activity_line = App\Models\Transaction\PersonalWorkloadActivityLine::where('personal_workload_activity_id',$personal_workload_activity->id)->where('month',$month)->first();
                                    @endphp
                                    @if(!$personal_activity)
                                        <form action="{{route('modules.performance.employee.create-activity')}}"  method="post" enctype="multipart/form-data">
                                            ...
                                            <tr id="row-activity-{{$personal_workload_activity->activity->id}}">
                                                <td>
                                                    <label class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$personal_workload_activity->activity->title}}</label>
                                                    <span class="text-muted fw-bold text-muted d-block fs-7">{{$personal_workload_activity->activity->activityType->name}}</span>
                                                </td>
                                                <td>
                                                    <input type="number" required name="target" class="form-control form-control-solid mb-3 fs-8 mb-lg-0 p-3" value="{{$personal_workload_activity_line->workload}}" placeholder="Capaian">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-primary fs-9">Format file pdf,png,jpeg,jpg</span>
                                                </td>
                                                <td>
                                        ...
                                        <form action="{{route('modules.performance.employee.update-activity')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <tr id="row-activity-{{$personal_workload_activity->activity->id}}">
                                                <td>
                                                    <label class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$personal_workload_activity->activity->title}}</label>
                                                    <span class="text-muted fw-bold text-muted d-block fs-7">{{$personal_workload_activity->activity->activityType->name}}</span>
                                                    <span class="badge badge-success mt-2">Sudah diisi</span>
                                                </td>
                                                <td>
                                                    <input type="number" required name="target" class="form-control form-control-solid mb-3 fs-8 mb-lg-0 p-3" value="{{$personal_workload_activity_line->workload}}" placeholder="Capaian">
                                                    <span class="text-muted fw-bold text-muted d-block fs-7">{{$personal_workload_activity->activity->unit_measure}}</span>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="modal_new_activity_form" class="form" action="#">
                        ...
                        <div class="mb-13 text-center">
                            ...
                            <!--end::Title-->
                            <!--begin::Description-->
                            <div class="text-muted fw-bold fs-5">Kinerja utama/tambahan</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Heading-->
                        ...
                        <div class="d-flex flex-column mb-5 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                <span class="required">Kinerja</span>
                            </label>
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select name="country" data-control="select2" data-dropdown-parent="#modal_new_activity" data-placeholder="Pilih Kinerja..." class="form-select form-select-solid">
