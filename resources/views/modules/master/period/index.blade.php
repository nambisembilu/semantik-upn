        ...
        const DatatableBasic = function () {
            ...
            const _componentDatatableBasic = function () {
                ...
                $('.datatable-server').DataTable({
                    ...
                    "scrollX": true,
                    "columns": [
                        {data: 'year', title: 'Tahun', orderable: true, searchable: true},
                        {data: 'description', title: 'Nama Periode', orderable: true, searchable: true},
                        {data: 'start_period', title: 'Tgl awal', orderable: true, searchable: true},
                        {data: 'end_period', title: 'Tgl Akhir', orderable: true, searchable: true},
                        {
